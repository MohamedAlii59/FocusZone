...
namespace DAL.DAL.Migrations
{
    ...
    public partial class StoredProcedures : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    ...
                    SELECT @TopicId AS TopicId, @Name AS Name, @Created AS Created;
                END;
            ");
        ...
        {
            migrationBuilder.Sql("DROP VIEW IF EXISTS [dbo].[UserSkillsView]");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[usp_ComputeEvidenceScore]");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[usp_UpdateMastery]");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[usp_RecalcDomainScore]");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[usp_ComputeConfidenceScore]");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[usp_ProcessSession]");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[usp_GetRecommendationPriorities]");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[usp_EnsureUserTopicMastery]");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[usp_GetOrCreateResource]");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[usp_UpsertTopic]");
